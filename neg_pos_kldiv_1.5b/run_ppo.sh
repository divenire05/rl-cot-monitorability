...
CRITIC=deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B
PROJECT=verl_gsm8k_ppo_DeepSeek-R1-Distill-Qwen-1.5B
EXP=DeepSeek-R1-Distill-Qwen-1.5B_kl-0.05+klInRewardTrue+sampTemp0.3_$(date +%Y%m%d_%H%M%S)
