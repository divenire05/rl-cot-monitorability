...
WANDB_API_KEY="c91f21fb97038ae66b147744595eb251f0ccfcea"
...
source /workspace/miniconda/etc/profile.d/conda.sh      # i think you might need to manually run this everytime - even after pausing instance and then re-connecting to it

conda activate verl     # then you have to manually run this everytime after running the above - maybe
...
pip install datasets huggingface_hub trl flash-attn
